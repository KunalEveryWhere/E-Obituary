                ...
                <form>
                          ...
                          <select value={templateID} onChange={(e) => setTemplateID(e.target.value)}>
                            ...
                            <select value={selectedFormat} onChange={(e) => setSelectedFormat(e.target.value)}>
                              <option value="1">背景樣式 1</option>
                              <option value="2">背景樣式 2</option>
                              <option value="3">背景樣式 3</option>
                              <option value="4">背景樣式 4</option>
                              <option value="5">背景樣式 5</option>
                              <option value="6">背景樣式 6</option>
                              <option value="7">背景樣式 7</option>
                            </select>
                          ...
                          <ReactQuill theme="snow" value={parameter1} onChange={setParameter1} readOnly={false} className='richEditor2' />

                          <label htmlFor="parameter2" style={{marginTop: '2em'}}>孝眷名單</label>
                          <ReactQuill theme="snow" value={parameter2} onChange={setParameter2} readOnly={false} className='richEditor2' />

                          <label htmlFor="parameter3" style={{marginTop: '2em'}}>親眷名單</label>
                          <ReactQuill theme="snow" value={parameter3} onChange={setParameter3} readOnly={false} className='richEditor2' />

                          <label htmlFor="parameter4" style={{marginTop: '2em'}}>儀式地點</label>
                          <ReactQuill theme="snow" value={parameter4} onChange={setParameter4} readOnly={false} className='richEditor2' />

                          <label htmlFor="parameter5" style={{marginTop: '2em'}}>禮俗提醒</label>
                          <ReactQuill theme="snow" value={parameter5} onChange={setParameter5} readOnly={false} className='richEditor2' />
    ...
    <div className='col-8 form-widget' aria-live="polite">
            <div className='card'>
              ...
              <button  onClick={() => window.location.reload()} className='button secondary block button-within-summary' aria-live="polite" ><img src={RefreshIcon} alt="Settings Icon" style={{height:"20px", verticalAlign:'middle', lineHeight: '36px'}}/>&nbsp;&nbsp;重新整理</button>
              {
                  ...
                  <p><b>背景樣式:&emsp;</b>{templateData.siteFormat}</p>
