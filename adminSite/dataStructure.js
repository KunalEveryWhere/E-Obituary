const database = {
    ...
    "generatedSites": { //Note: Each set of entry represents one row in the table.
        ...
        "parameter5": "BlaBlaBla", //varchar Text Type. Stores the content for the fifth Parameter.
        "parameter6": "BlaBlaBla", //varchar Text Type. Stores the content for the sixth Parameter.
        "parameter7": "BlaBlaBla", //varchar Text Type. Stores the content for the sixth Parameter. (may be used as buffer)
        "parameter8": "BlaBlaBla", //varchar Text Type. Stores the content for the sixth Parameter. (may be used as buffer)
    ...
    /*Table 6 */ //This table is used to store the total number of sites published using the adminSite
    "siteColumnCount": {
        "id": 20230104, //int value. This is a locked UUID which corrospends to Jan 4 2023 date.
        "count": 1 //int value. This started from value of 0, and the increased by one every time a new site is published.
    }
}

const buckets = {
    /*Storage Bucket 1*/ //This keeps track of the total number of sites published through the admin app.
    "companylogo": [
