...
export default function Signup() {
  ...
  const TCURL = "https://drive.google.com/file/d/1mheDpT85UFPfvAu8KLcnOrsDdtLg7lUV/view?usp=sharing";
            ...
            <div>
              <h4>申請帳號</h4>
                        <form onSubmit={handleSignUp}>
                          ...
                          type="checkbox"
                          value="Terms&ConditionsCheckBox"
                          checked={checkedTC}
                          onChange={handleTCCheckboxChange} 
                          /> <a href={TCURL} target="_blank" rel='noreferrer'>我同意及接受本服務條款</a>
                          </div>
                          <button className="button primary block" aria-live="polite" disabled={!checkedTC}>
                          註冊
                          </button>
                        </form>
